...
import org.jhipster.helloapp.domain.Entry;
import org.jhipster.helloapp.repository.EntryRepository;
...
/**
 * REST controller for managing {@link org.jhipster.helloapp.domain.Entry}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EntryResource {
   ...
   public ResponseEntity<List<Entry>> getAllEntries(Pageable pageable,
        ...
        Page<Entry> page1=entryRepository.findByBlogUserLoginOrderByDateDesc(SecurityUtils.getCurrentUserLogin().orElse(null), pageable);
